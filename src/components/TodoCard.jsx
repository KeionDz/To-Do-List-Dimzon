    ...
    <Card className="bg-[#232323] text-white rounded-xl shadow-md transition-all duration-300 hover:shadow-[0px_4px_20px_rgba(0,255,255,0.5)] p-6 border border-gray-600 w-full max-w-[400px]">
      ...
      <CardFooter className="flex justify-end p-4">
        <AlertDialog open={open} onOpenChange={setOpen}>
          ...
          <AlertDialogContent className="bg-[#1E1E1E] border border-gray-700 text-white">
            <AlertDialogHeader>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel className="border border-gray-600 text-gray-400 px-4 py-2 rounded-lg hover:bg-gray-800 hover:text-white transition">
                Cancel
              </AlertDialogCancel>
              <AlertDialogAction
